...
from packages.views import partner_view, package_view, order_view, staff_view, order_edit_view, package_edit_view, partner_search
...
urlpatterns = [
    ...
    path('partners/<str:partner>/<str:order>/', order_edit_view),
