# Generated by Django 2.2.12 on 2021-02-09 18:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('Awaiting collection', 'Awaiting collection'), ('Received by the company', 'Received by the company'), ('On route to destination', 'On route to destination'), ('Delivered', 'Delivered')], default='Awaiting collection', max_length=32)),
